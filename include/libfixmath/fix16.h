...
/* для ускоренного перевода в double/float =  */
static const double fix16_to_double_coeff = 0.0000152587890625; /* 1.0 / fix16_one */
...
*/
/* my implementation */
static inline float   fix16_to_float(fix16_t a) { return (float)a  * fix16_to_double_coeff; }
static inline double  fix16_to_dbl(fix16_t a)   { return (double)a * fix16_to_double_coeff; }
...
//#define fix16_from_dbl(a) ((a) * fix16_one)
